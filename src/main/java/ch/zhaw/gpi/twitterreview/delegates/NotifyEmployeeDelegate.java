...
/**
 * Iplementation des Send Task "Mitarbeiter benachrichtigen"
 * @author Saletta
 */
...
public class NotifyEmployeeDelegate implements JavaDelegate{
    ...
    /**
     * Mockt das Senden einer Beanchrigigung per Mail
     * 
     * 1. Die Prozessvariabeln ausles
     * 2. Die E-Mail Nachricht zusammenstellen
     * 3. Die E-Mail der Konsole ausgeben
     * 
     * @param de    Objekt, welches die Verknüpfung zur Process Engine und aktuellen Executions enthält
     * @throws Exception
     */
    @Override
